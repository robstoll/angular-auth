    ...
    describe('', function() {
        ...
        describe('logout:', function() {
            ...
            describe('LoginService rejects -', function(){
                var response = {};
                beforeEach(inject(function($q){
                    LoginService.logout.and.callFake(function() { return $q.reject(response); });
                }));
                
                it('does not destroy the Session', function() {
                    var user = {role:'admin'};
                    Session.create(user);
                ...
                it('returns a promise which rejects', function(){
                    AuthService.logout().then(function() { fail('returned a promiss which fulfilled'); });
                });
            });
            ...
            describe('LoginService fulfills -', function() {
                ...
                var response = {};
                beforeEach(inject(function($q){
                    LoginService.logout.and.callFake(function() { return $q.resolve(response); });
                }));
                
                it('broadcasts AUTH_EVENTS.logoutSuccess', function(){
                    AuthService.logout();
                    $rootScope.$apply();
                    expect($rootScope.$broadcast).toHaveBeenCalledWith(AUTH_EVENTS.logoutSuccess, Session);
                });
